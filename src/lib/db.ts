...
CREATE TABLE IF NOT EXISTS ReceiptSettings (
  id TEXT PRIMARY KEY NOT NULL DEFAULT 'default',
  receiptSize TEXT NOT NULL DEFAULT '58mm',
  customWidth REAL NOT NULL DEFAULT 58,
  customHeight REAL NOT NULL DEFAULT 0,
  layout TEXT NOT NULL DEFAULT 'left',
  showLogo BOOLEAN NOT NULL DEFAULT 1,
  showShopName BOOLEAN NOT NULL DEFAULT 1,
  showSubName BOOLEAN NOT NULL DEFAULT 1,
  showShopAddress BOOLEAN NOT NULL DEFAULT 1,
  showShopPhone BOOLEAN NOT NULL DEFAULT 1,
  showInvoiceNo BOOLEAN NOT NULL DEFAULT 1,
  showDateTime BOOLEAN NOT NULL DEFAULT 1,
  showCustomerName BOOLEAN NOT NULL DEFAULT 1,
  showCustomerPhone BOOLEAN NOT NULL DEFAULT 0,
  showSaleType BOOLEAN NOT NULL DEFAULT 1,
  showPaymentMethod BOOLEAN NOT NULL DEFAULT 1,
  showCardDetails BOOLEAN NOT NULL DEFAULT 1,
  showBarcode BOOLEAN NOT NULL DEFAULT 1,
  showFooter BOOLEAN NOT NULL DEFAULT 1,
  fontFamily TEXT NOT NULL DEFAULT 'Consolas',
  fontSize INTEGER NOT NULL DEFAULT 9,
  fontBold BOOLEAN NOT NULL DEFAULT 1,
  headerFontSize INTEGER NOT NULL DEFAULT 13,
  titleFontSize INTEGER NOT NULL DEFAULT 11,
  textColor TEXT NOT NULL DEFAULT '#000000',
  headerColor TEXT NOT NULL DEFAULT '#000000',
  marginTop REAL NOT NULL DEFAULT 2,
  marginBottom REAL NOT NULL DEFAULT 2,
  marginLeft REAL NOT NULL DEFAULT 3,
  marginRight REAL NOT NULL DEFAULT 1,
  lineSpacing REAL NOT NULL DEFAULT 1.2,
  receiptFooter TEXT,
  showItemDetails BOOLEAN NOT NULL DEFAULT 1,
  showSubtotal BOOLEAN NOT NULL DEFAULT 1,
  showTax BOOLEAN NOT NULL DEFAULT 1,
  showDiscount BOOLEAN NOT NULL DEFAULT 1,
  showChange BOOLEAN NOT NULL DEFAULT 1,
  createdAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updatedAt DATETIME NOT NULL
);
`;
